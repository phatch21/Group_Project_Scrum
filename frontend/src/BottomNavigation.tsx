...
const adjustSvgColor = (svg: string, isActive: boolean) => {
  return svg.replace(
...
const BottomNavigation: React.FC = () => {
  ...
  const getActiveIcon = (): string => {
    ...
    if (path.startsWith("/menu")) return "target";
    if (path.startsWith("/Customization")) return "image";
    if (path === "/") return "home";
    if (path.startsWith("/Orchard")) return "users";
    if (path.startsWith("/Settings")) return "tool";
    ...
    <section className={styles.container}>
      <div className={styles.navigationWrapper}>
        ...
        <nav className={styles.navigationBar}>
          <NavIcon
            iconName="target"
            svgContent={adjustSvgColor(TARGET_ICON, activeIcon === "target")}
          ...
          <NavIcon
            iconName="image"
            svgContent={adjustSvgColor(IMAGE_ICON, activeIcon === "image")}
          ...
          <NavIcon
            iconName="home"
            svgContent={adjustSvgColor(HOME_ICON, activeIcon === "home")}
          ...
          <NavIcon
            iconName="users"
            svgContent={adjustSvgColor(USERS_ICON, activeIcon === "users")}
          ...
          <NavIcon
            iconName="tool"
            svgContent={adjustSvgColor(TOOL_ICON, activeIcon === "tool")}
